...
typedef AnimatingItemBuilder<W extends Widget, E> = W Function(
...
abstract class ImplicitlyAnimatedListBase<W extends Widget, E extends Object>
  ...
  final AnimatingItemBuilder<W, E> itemBuilder;
...
abstract class ImplicitlyAnimatedListBaseState<W extends Widget,
  ...
  @nonVirtual
  @protected
  AnimatingItemBuilder<W, E> get itemBuilder => widget.itemBuilder;
  @nonVirtual
  @protected
